...
#        return self.turns[self.turn]
    ...
    def render(self, mode='human'):
        ...
        print('self.orders_out >>> ', self.orders_out)
        print('self.shipments_out >>> ', self.shipments_out)
        print('self.orders_in >>> ', self.orders_in)
        print('self.shipments_in >>> ', self.shipments_in)
        print()
